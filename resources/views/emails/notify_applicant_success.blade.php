...
<head>
  ...
  <title>African Technical Training Centre Admin Notification</title>
  <style type="text/css">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="bodycopy">
                  ...
                  This is to notify you that your application into the <strong>{{$programme_name}}</strong> programme for the <strong>Batch No {{$batch_no}}</strong>  {{--of the <strong>{{$programme_type}}</strong>
