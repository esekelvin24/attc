...
<head>
  ...
  <title>ATTC Account Creation</title>
  <style type="text/css">
          ...
          <td class="innerpadding borderbottom">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="bodycopy">
                  <br/>
                  Your ATTC Portal account has been created successfully, Below is your login credential: <br/><br/>
                  <strong>Username: </strong> {{$email}}<br/>
                  
                  <br/><br/>
                 <p>You can now apply for a programme when you login using the above username and the password your entered during registration</p>
                </td>
              </tr>
