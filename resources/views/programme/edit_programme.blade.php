...
<div class="content-box">
    ...
    <div class="row">
        <div class="col-sm-12">
                <form id="form" action="{{route('save_edited_programme')}}" method="post" enctype="multipart/form-data"  role="form">
               @csrf

                 <input required id="programme_id" name="programme_id" value="{{encrypt($programme_collections[0]->programme_id)}}" type="hidden" >
               <div>
               ...
               <div  class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <br/><img height="120" width="120" id="blah" src="{{asset("frontend/assets/img/programmes/".$programme_collections[0]->disp_img."?".rand(1,9999999))}}" alt="your image" /><br/>
