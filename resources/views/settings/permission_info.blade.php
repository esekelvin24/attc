        ...
        <table id="tblmarketerinfo" class="table table-bordered"> 
                                    ...
                                    <tbody>
                                        <tr class="even pointer">
                                            ...
                                            <td class="pull-xs-left col-sm-9 col-xs-8">{{$permission_collection[0]->name}}</td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr class="even pointer">
                                            ...
                                            <td class="pull-xs-left col-sm-9 col-xs-8">{{$permission_collection[0]->slug}}</td>
                                        </tr>
                                    </tbody>
                                    ...
                                    <tbody>
                                        <tr class="even pointer">
                                            ...
                                            <td class="pull-xs-left col-sm-9 col-xs-8">{{$permission_collection[0]->description}}</td>
                                        </tr>
                                    </tbody>
                                <tbody>
                                    <tr class="even pointer">
